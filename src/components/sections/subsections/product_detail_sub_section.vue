        ...
        <div class="product-info row">
            ...
            <div class="details-box">
              <div class="ads-details-info">
                ...
                <div class="details-meta">
                  <span
                    ><a href="#"><i class="lni-alarm-clock"></i> 7 Jan, 10:10 pm</a></span
                  >
                  <span
                    ><a href="#"><i class="lni-map-marker"></i> New York</a></span
                  >
                  <span
                    ><a href="#"><i class="lni-eye"></i> 299 View</a></span
                  >
                </div>
                <p class="mb-4">
                  Up for sale we have a vintage Raleigh Sport Men’s Bicycle. This bike
                  does have some general wear and surface corrosion on some of the parts
                  but is overall in good shape. It has been checked out and does work.
                  Brakes and gears work. Seat is fully intact. Frame and fenders are in
                  nice shape with minimal wear. A few minor dents in the fenders but most
                  of the paint is intact. This vintage bicycle is very well preserved and
                  can be used the way it is or fully restored if you would like it to look
                  newer.
                </p>
                <h4 class="title-small mb-3">Détails</h4>
                <ul class="list-specification">
                  <li><i class="lni-check-mark-circle"></i> 256GB PCIe flash storage</li>
                  <li>
                    <i class="lni-check-mark-circle"></i> 2.7 GHz dual-core Intel Core i5
                  </li>
                  ...
                  <li>
                    <i class="lni-check-mark-circle"></i> 1 Year international warranty
                  </li>
                </ul>
                <p class="mb-4">
                  Up for sale we have a vintage Raleigh Sport Men’s Bicycle. This bike
              ...
              <div class="tag-bottom">
                <div class="float-left">
                  <ul class="advertisement">
                    <li>
                      <p>
                        <strong><i class="lni-folder"></i> Categories:</strong>
                        <a href="#">Electronics</a>
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong><i class="lni-archive"></i> Condition:</strong> New
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong><i class="lni-package"></i> Brand:</strong>
                        <a href="#">Apple</a>
                      </p>
                    </li>
                  </ul>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <aside class="details-sidebar">
              <div class="widget">
                <h4 class="widget-title">Produit posté par</h4>
                  ...
                  <div class="agent-title">
                    ...
                    <div class="agent-details">
                      ...
                      <span class="text-black-50"
                        ><i class="lni-phone-handset"></i>(123) 123-456</span
                      ><br />
                      <span class="text-primary"
                        ><i class="lni-envelope"></i>Tahmina@gmail.com</span
                      ><br />
              ...
              <div class="widget">
                <h4 class="widget-title">Produits similaires</h4>
                <ul class="posts-list">
                  <li>
