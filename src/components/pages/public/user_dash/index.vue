    ...
    <div class="page-content">
      <div class="inner-box">
        <div class="dashboard-box">
          <h2 class="dashbord-title">Accueil</h2>
        </div>
            ...
            <tbody>
              <tr data-category="active">
                ...
                <td data-title="Category">
                  <span class="adcategories">Laptops & PCs</span>
                </td>
              ...
              <tr data-category="expired">
                ...
                <td class="photo">
                  <img class="img-fluid" src="assets/img/product/img9.jpg" alt="" />
                </td>
                <td data-title="Title">
              ...
              <tr data-category="deleted">
                ...
                <td class="photo">
                  <img class="img-fluid" src="assets/img/product/img10.jpg" alt="" />
                </td>
                <td data-title="Title">
                ...
                <td data-title="Ad Status">
                  <span class="adstatus adstatusdeleted">Deleted</span>
                </td>
                <td data-title="Price">
                  <h3>$389</h3>
                </td>
